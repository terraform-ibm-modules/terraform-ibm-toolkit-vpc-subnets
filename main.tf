...
locals {
  ...
  default_acl_rules  = [{
    name = "${locals.name_prefix}-allow-ingress-internal"
    action = "allow"
    direction = "inbound"
    source = "10.0.0.0/8"
    destination = "10.0.0.0/8"
  }, {
    name = "${locals.name_prefix}-allow-roks-ingress"
    action = "allow"
    direction = "inbound"
    source = "166.8.0.0/14"
    destination = "10.0.0.0/8"
  }, {
    name = "${locals.name_prefix}-allow-vse-ingress"
    action = "allow"
    direction = "inbound"
    source = "161.26.0.0/16"
    destination = "10.0.0.0/8"
  }, {
    name = "${locals.name_prefix}-allow-egress-internal"
    action = "allow"
    direction = "outbound"
    source = "10.0.0.0/8"
    destination = "10.0.0.0/8"
  }, {
    name = "${locals.name_prefix}-allow-roks-egress"
    action = "allow"
    direction = "outbound"
    source = "10.0.0.0/8"
    destination = "166.8.0.0/14"
  }, {
    name = "${locals.name_prefix}-allow-vse-egress"
    action = "allow"
    direction = "outbound"
    source = "10.0.0.0/8"
